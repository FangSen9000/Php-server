        ...
        <div class="col-sm-6 jumbotron">
            <form action="" method="post" novalidate="true" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="date" name="booking_date" maxlength="10" value='<?= $booking_date ?>' />
                </div>
                <div class="form-group">
                    <label>
                        Booking Time:
                    ...
                    <input class="form-control" type="time" name="booking_time" maxlength="10" value='<?= $booking_time ?>'/>
                </div>
                <div class="form-group">
                    <label>
                        Number of People:
                    ...
                    <input class="form-control" type="text" name="num_people" maxlength="10" value='<?= $num_people ?>'/>
                </div>
